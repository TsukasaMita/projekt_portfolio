const questions = [
  {
    "question": "which of the following are topics for the developers to discuss at the daily scrum as they inspect their progress towards the Sprint goal Which of the following are topics for the Developers to discuss at the Daily Scrum as they inspect their progress toward the Sprint Goal?",
    "answer": [
      {
  ...
  {
    "question": "B. What will I be working on tomorrow?",
    "answer": [
      {
  ...
  {
    "question": "C. How many hours did I spend on the project yesterday?",
    "answer": [
      {
      ...
      {
        "text": "Will today's work negatively impact our ability to meet the Sprint Goal for the",
        "correct": null
      }
    ]
  },
  {
    "question": "E. Why were you late?",
    "answer": [
      {
  ...
  {
    "question": "F. Are there any impediments blocking progress toward the Sprint Goal?",
    "answer": [
      {
      ...
      {
        "text": "Are there any decisions that need to be made to maintain progress toward the",
        "correct": null
      }
    ]
  },
  ...
  },
  {
    ...
    "answer": [
      ...
      {
        "text": "The consistency reduces complexity. a scrum master is working with a scrum team that has developers in different physical locations A Scrum Master is working with a Scrum Team that has Developers in different physical locations. The Developers meet in a variety of meeting rooms and have much to do logistically (for example: reserve meeting rooms and set up conference calls) before the Daily Scrum.",
        "correct": null
      }
    ]
  },
  {
    "question": "What action should the Scrum Master take?",
    "answer": [
      {
  ...
  },
  {
    ...
    "answer": [
      ...
      {
        "text": "The Scrum Master why does the product owner want the developers to adhere to its definition of done",
        "correct": null
      }
    ]
  },
  ...
  },
  {
    ...
    "answer": [
      ...
      {
        "text": "All of the above are allowed depending on the situation. who determines how many product backlog items the developers select for a Sprint",
        "correct": null
      }
    ]
  },
  ...
  },
  {
    ...
    "answer": [
      ...
      {
        "text": "They are discussed, determined, and documented before the actual feature development Sprints. which phrase best describes a product owner",
        "correct": null
      }
    ]
  },
  ...
  {
    "question": "Which of the following actions should the Scrum Master support?",
    "answer": [
      {
