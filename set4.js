const questions = [
    {
        ...
        answer: [
            ...
            { text: "What will I be working on tomorrow?", correct: true },
            ...
            { text: "Are there any decisions that need to be made to maintain progress toward the Sprint Goal?", correct: false }
        ]
    },
    {
    ...
    {
        question: "A Scrum Master is working with a Scrum Team that has Developers in different physical locations. What action should the Scrum Master take?",
        answer: [
    ...
    {
        question: "During Sprint Planning the Product Owner and the Developers are unable to reach an understanding about the highest order Product Backlog items. Which actions should the Scrum Master support?",
        answer: [
    ...
    },
    {
        ...
        answer: [
            ...
            { text: "What is the right mixture of senior and junior people on each team?", correct: false },
            { text: "How will we make sure all teams have the right amount of expertise?", correct: true },
            { text: "Who are the subject matter experts on each team?", correct: false }
        ]
    },
    {
        question: "Which are characteristics of the Daily Scrum?",
        answer: [
            { text: "It is free form and designed to promote conversation", correct: false },
            { text: "It is facilitated by the team lead", correct: false },
            { text: "It is held first thing in the morning", correct: false },
            { text: "It consists of the Scrum Master asking the team for status", correct: false },
            { text: "Its location and time remain constant", correct: true },
            { text: "Its purpose is to inspect progress toward the Sprint Goal and adapt the Sprint Backlog", correct: true }
        ]
    },
    {
        question: "One of the Scrum events is the Daily Scrum. What are two intended outcomes of the Daily Scrum?",
        answer: [
            { text: "An updated Scrum board to make Sprint progress transparent for the stakeholders", correct: false },
            { text: "Identification of impediments that may prevent the Developers from achieving the Sprint Goal", correct: true },
            { text: "A status report for the upper management indicating what each individual has done, will be doing, and what is impeding him/her", correct: false },
            { text: "A shared understanding of the most important work to be undertaken next to achieve the best possible progress toward the Sprint goal", correct: true },
            { text: "An update of completed tasks and of the remaining work so the Scrum Master can plan the next day", correct: false }
        ]
    },
    {
        ...
        answer: [
            ...
            { text: "Remove or change selected Product Backlog items", correct: true },
            { text: "The Developers work overtime during this Sprint", correct: false },
            { text: "Recruit additional Developers before the work can begin", correct: false },
            { text: "The Developers ensure that the Scrum Team is aware, start the Sprint, and monitor progress", correct: true }
        ]
    },
    {
        question: "In accordance with Scrum theory, how should a group of 100 people be divided into multiple Scrum Teams?",
        answer: [
            { text: "Create a matrix of skills, seniority, and level of experience to assign people to teams", correct: false },
            { text: "Check with the allocation department to see who has worked together before and make these the first teams", correct: false },
            { text: "Understanding the product, the product vision and the rules of the Scrum framework, the people divide themselves into teams", correct: true },
            { text: "It does not really matter since you can rotate the teams every Sprint to spread knowledge", correct: false }
        ]
    },
    {
        ...
        answer: [
            ...
            { text: "Always deliver the items in the Sprint forecast", correct: false },
    ...
    },
    {
        ...
        answer: [
            { text: "Methods of communication", correct: true },
            { text: "The way the Scrum Team does Sprint Planning", correct: true },
            { text: "Skills needed to improve the Developers ability to deliver", correct: true },
            { text: "The Definition of Done", correct: true },
    ...
    },
    {
        ...
        answer: [
            { text: "Form a separate team of technical writers that will work on an on-demand basis for the various Product Owners. Work order will be first in, first out", correct: false },
            { text: "Let the user documentation remain undone and accumulate until after the last development Sprint. It will then be done by any available technical writers", correct: false },
            { text: "Wait until you have a technical writer on your Scrum Team to take care of this", correct: false },
            { text: "The Developers on the Scrum Team should write the user documentation", correct: true }
        ]
    },
    {
        ...
        answer: [
            ...
            { text: "When the item has gained product sponsor approval", correct: false },
    ...
    },
    {
        ...
        answer: [
            ...
            { text: "The Scrum Master, project manager and the Developers", correct: false },
            { text: "The Scrum Master and the Developers", correct: true },
    ...
    },
    {
        ...
        answer: [
            { text: "Refine the Product Backlog", correct: true },
            { text: "Work with the Quality Assurance departments on the Increment of the current Sprint", correct: false },
            { text: "Update the project plan with stakeholders", correct: false },
            { text: "There are no such activities. The next Sprint starts immediately after the current Sprint", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        answer: [
            { text: "Summarizing and reporting the discussions to management", correct: false },
            { text: "Acting as a scribe to capture the Scrum Team's answers", correct: false },
            { text: "Participating as a Scrum Team member and facilitating as requested or needed", correct: true },
    ...
    },
    {
        ...
        answer: [
            { text: "As soon as a Developer on the Scrum Team can accommodate more work", correct: false },
            { text: "During the Daily Scrum", correct: false },
            { text: "At Sprint Planning when all of the Sprint Backlog items are split evenly across the Developers", correct: false },
            { text: "Never. All Developers on the Scrum Team share accountability for items in the Sprint Backlog", correct: true }
        ]
    },
    {
        question: "At the seventh Sprint Review, the stakeholders are disappointed and angry. What factors likely led to this?",
        answer: [
            { text: "The stakeholders were not allowed to prioritize Product Backlog items", correct: false },
            { text: "The Product Owner has not been keeping the stakeholders aware of the progress of the project", correct: true },
            { text: "The Project Management Office (PMO) has not been engaged adequately", correct: false },
            { text: "The stakeholders have not been using the Sprint Reviews to inspect and evaluate progress", correct: true }
        ]
    },
    {
    ...
    },
    {
        ...
        answer: [
            ...
            { text: "No work is left to meet the Definition of Done", correct: true },
            { text: "Whatever the Product Owner defines as quality", correct: false },
    ...
    },
    {
        ...
        answer: [
            { text: "The Scrum Master, or the Scrum Master may have the Developers do it", correct: false },
            { text: "The Product Owner", correct: true },
            { text: "The business analyst who represents the Product Owner", correct: false },
            { text: "The Scrum Master", correct: false }
        ]
    },
    {
        question: "The Daily Scrum is an event that happens every day. What would be three key concerns if the frequency were lowered to every two or three days?",
        answer: [
            { text: "The Scrum Master loses the ability to update the Gantt chart properly", correct: false },
            { text: "Impediments are raised and resolved more slowly", correct: true },
            { text: "The Sprint Backlog may become inaccurate", correct: true },
            { text: "The Product Owner cannot accurately report progress to the stakeholders", correct: true },
            { text: "Too much work is spent updating the Scrum board before the meeting", correct: false },
            { text: "Opportunities to inspect and adapt the Sprint Backlog are lost", correct: true }
        ]
    }
];
