const questions = [
    ...
    {
        question: "You are the Scrum Master of a new, to be developed Product requiring 45 people. What is a good first question to suggest when forming into teams?",
        answer: [
    ...
    },
    {
        ...
        answer: [
            {text: "It is free form and designed to promote conversation", correct: true},
    ...
    {
        question: "User documentation is part of your Definition of Done. However, there are not enough technical writers. What should the Scrum Team do?",
        answer: [
            {text: "Form a separate team of technical writers that will work on an on-demand basis", correct: false},
            {text: "Let the user documentation remain undone and accumulate until after the last development Sprint", correct: false},
    ...
    },
    {
        ...
        answer: [
            ...
            {text: "Work with the Quality Assurance departments on the Increment", correct: false},
            {text: "Update the project plan with stakeholders", correct: false},
            {text: "There are no such activities. The next Sprint starts immediately", correct: false}
        ]
    },
    {
    ...
    {
        question: "The Daily Scrum is an event that happens every day. What are two intended outcomes?",
        answer: [
            {text: "An updated Scrum board to make Sprint progress transparent for the stakeholders", correct: false},
            {text: "Identification of impediments that may prevent the Developers from achieving the Sprint Goal", correct: true},
            {text: "A status report for the upper management indicating what each individual has done, will be doing, and what is impeding him/her", correct: false},
