const questions = [
    ...
    {
        question: "Which two activities would probably help a newly formed Scrum Team in starting up?",
        answer: [
            {text: "Ask the Product Owner to discuss the product, its vision, history, goals, and context, as well as answer questions", correct: true},
            ...
            {text: "Have the manager for each Developer introduce their direct reports and go over their responsibilities", correct: false}
        ]
    },
    {
    ...
    {
        question: "Which of the following are responsibilities of a Product Owner on a Scrum Team?",
        answer: [
    ...
    {
        question: "What will likely happen if an organization changes Scrum terminology to fit existing terms?",
        answer: [
            {text: "Without a new vocabulary as a reminder of the change, very little change may actually happen", correct: true},
            {text: "The organization may not understand what has changed within Scrum and the benefits may be lost", correct: false},
            {text: "Management may feel less anxious", correct: false},
            {text: "All answers apply", correct: false}
        ]
    },
    {
        question: "When multiple Scrum Teams are working together on a single product, what best describes the Definition of Done?",
        answer: [
            {text: "Each Scrum Team defines and uses its own. The differences are discussed in a hardening Sprint", correct: false},
            {text: "The Scrum Masters define a common Definition of Done", correct: false},
            {text: "Each Scrum Team uses its own, but differences are made clear to all teams", correct: false},
            {text: "They must mutually define and comply with the same Definition of Done", correct: true}
        ]
    },
    {
        question: "Why do the Developers need a Sprint Goal?",
        answer: [
            {text: "It ensures that all selected Product Backlog items are implemented", correct: false},
    ...
    {
        question: "What is the key concern when multiple Scrum Teams use the same Product Backlog?",
        answer: [
            ...
            {text: "Making sure there is enough work for everyone", correct: false},
    ...
    },
    {
        ...
        answer: [
            {text: "They work closely with external specialists", correct: false},
            {text: "They include skilled individuals who together have all the skills necessary to create value each Sprint", correct: true},
            {text: "They are a virtual team drawing from separate groups", correct: false},
            {text: "They include not only developers but also business analysts, architects, and testers", correct: false}
        ]
    },
    {
    ...
    {
        question: "Five new Scrum Teams have been created to build one product. How should Developers coordinate with the other teams?",
        answer: [
            {text: "Collect and merge Sprint tasks into a consolidated plan", correct: false},
            {text: "They are responsible to work with the other teams to create an integrated Increment", correct: true},
            {text: "Teach the Product Owner to order to avoid overlap", correct: false},
            {text: "Inspect alignment daily by visiting all teams", correct: false}
        ]
    },
    {
        question: "Which statement best describes the Sprint Review?",
        answer: [
            {text: "A mechanism to control the Developers activities", correct: false},
            {text: "Used to congratulate or punish based on forecast", correct: false},
            {text: "When the Scrum Team and stakeholders inspect the outcome and figure out what to do next", correct: true},
            {text: "A demo for everyone in the organization", correct: false}
        ]
    },
    {
        question: "Which outcome is expected as a Scrum Team matures?",
        answer: [
            {text: "A Scrum Master is no longer needed", correct: false},
    ...
    {
        question: "A Scrum Team has decided that a Sprint Retrospective is unnecessary. What should the Scrum Master do?",
        answer: [
            {text: "Comply with the decision of the self-managing team", correct: false},
            {text: "Consult with the Product Owner", correct: false},
    ...
    },
    {
        ...
        answer: [
            ...
            {text: "The Product Owner can be represented by a committee", correct: false},
    ...
    },
    {
        ...
        answer: [
            ...
            {text: "Postpone the work until a specialist can perform a security audit", correct: false},
            {text: "Delegate the work to the security department", correct: false}
        ]
    },
    {
        question: "A Scrum Team is experiencing a growing list of impediments. Which techniques would be most helpful?",
        answer: [
    ...
    },
    {
        ...
        answer: [
            ...
            {text: "Scrum is a methodology where you can pick and choose parts", correct: false},
            {text: "Scrum implements self-management by replacing Project Managers", correct: false},
            {text: "Each component of Scrum serves a specific purpose and is essential", correct: true}
        ]
    },
    {
        ...
        answer: [
            ...
            {text: "Analyze, describe, and document the requirements for subsequent Sprints", correct: false}
        ]
    },
    {
        question: "The CEO asks the Developers to add a 'very important' item to a Sprint in progress. What should the Developers do?",
        answer: [
    ...
    {
        question: "True or False: A high-performance Scrum Team ensures each Increment is complete by running a Release Sprint.",
        answer: [
            {text: "True", correct: false},
            {text: "False", correct: true}
        ]
    ...
    },
    {
        ...
        answer: [
            {text: "Keeping track of undone work in a hardening Sprint", correct: false},
            {text: "Doing all work needed to meet the Definition of Done", correct: true},
            {text: "Reporting Sprint progress to stakeholders daily", correct: false},
